...
export default async () => {
  ...
  return {
    ...
    '@nestjs/graphql/plugin': {
      models: [
        [
          import('./authn/models/token.model'),
          { Token: { accessToken: {}, refreshToken: {} } },
        ],
        [
          import('./authn/dto/signup.input'),
          {
            SignupInput: {
              email: {},
              password: {},
        ...
        [
          import('./authn/models/jwt-sign.model'),
          { JwtSignModel: { JWT_ACCESS_SECRET: {}, JWT_REFRESH_SECRET: {} } },
        ],
        [
        ...
        [
          import('./authn/models/auth.model'),
          {
            Auth: { user: { type: () => t['./users/models/user.model'].User } },
          },
        ],
        [
          import('./authn/dto/login.input'),
          { LoginInput: { email: {}, password: {} } },
        ],
        [
          import('./authn/dto/refresh-token.input'),
